...
{
	#region PluginInfo
	[PluginInfo(Name = "AreaMerge", Category = "Value", Version = "DynamicPins", Help = "Basic template with a dynamic amount of in- and outputs", Tags = "")]
	#endregion PluginInfo
	public class DynamicPinsValueAreaMergeNode : IPluginEvaluate, IPartImportsSatisfiedNotification
	{
		#region fields & pins
