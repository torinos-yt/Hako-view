...
{
	[PluginInfo(Name = "NodeCons", Category = "Node", Version = "Source", Help = "Basic template with one value in/out", Tags = "")]
	public class SourceNodeNodeConsNode : IPluginEvaluate
	{
